 ...
 * @author Mithrandir
 */
public class staffadvancePanel extends javax.swing.JPanel {

    /**
     * Creates new form staffadvancePanel
     */JPanel childPanel;
     Staff s=new Staff();
    public staffadvancePanel() {
        initComponents();
        s.STAFFADVANCErecord(jTable1);
    }
    ...
    private void initComponents() {
        ...
        advance.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        ...
        jLabel27.setText("PREVIOUS ADVANCE");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(advance, javax.swing.GroupLayout.PREFERRED_SIZE, 271, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jPanel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel2MouseClicked
        ...
        Staff st=new Staff();
        st.updateadvance(Amount.getText(), TeacherID.getText());
        st.STAFFADVANCErecord(jTable1);
        name.setText("");
        advance.setText("");
        TeacherID.setText("");
        Amount.setText("0");
    ...
    private void TeacherIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TeacherIDActionPerformed
        ...
        if (staff.searchEmployee(TeacherID.getText())){
        staff.STAFFADVANCErecordSearch(jTable1, TeacherID.getText());}
        else {
 ...
 return;
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        // TODO add your handling code here:
        Staff st=new Staff();
        st.clickAdvanceTableToText(jTable1, TeacherID, name, advance);
        s.STAFFADVANCErecord(jTable1);
